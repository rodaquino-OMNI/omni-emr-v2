...
// Barrel exports for patient view components
export { default as DefaultPatientView } from './DefaultPatientView';
...
export { default as MedicalStaffPatientView } from './MedicalStaffPatientView';
