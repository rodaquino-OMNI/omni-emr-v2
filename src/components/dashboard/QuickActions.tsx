...
import { Pill, Calendar, FileText, MessageSquare, Video, Users, ClipboardList, Activity, Droplet, ClipboardCheck, LogOut, Syringe, FlaskConical } from 'lucide-react';
...
const QuickActions = () => {
  ...
  // All quick actions - each user role will get a filtered subset based on permissions and role
